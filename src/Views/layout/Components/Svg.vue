<template>
    <a-icon :component="component" />
</template>
<script>
    const SVG_LIST={
        Home: {
            template: `
                <svg class="icon" style="" viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor" >
    ...
    //自定义icon组件，需要在config中使用 runtimeCompiler: true规则
    export default {
        props:{
            type:{
                type:String,
